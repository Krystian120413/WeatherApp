    ...
    inner class WeatherTask : AsyncTask<String, Void, String>() {
        ...
        override fun onPostExecute(result: String) {
            ...
            try {
                ...
                findViewById<TextView>(R.id.text1).text = "data tutaj"
                ...
                findViewById<TextView>(R.id.text2).text = "data tutaj"
                ...
                findViewById<TextView>(R.id.text3).text = "data tutaj"
                ...
                findViewById<TextView>(R.id.text4).text = "data tutaj"
